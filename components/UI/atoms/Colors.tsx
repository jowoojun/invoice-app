...
export const ModalBackgroundColor = (darkMode: boolean) => ( darkMode ? "#141625" : "#FFFFFF");
...
export const FontBillTitle = "#7C5DFA"
export const FontBillTotalPriceColor = "#888eb0"
...
export const BlackButton = "#373B53";
...
// input
export const InvoiceInputColor = (darkMode: boolean) => ( darkMode ? "#1E2139" : "#DFE3FA");
// InvoiceDetailPrice
